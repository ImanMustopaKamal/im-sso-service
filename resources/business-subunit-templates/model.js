const helpers = require("../../utils/helpers"),
  ...
  table = db_sso+".ms_business_subunit_template",
  tbl_alias = "subunit_template",
  ...
  GetAll: async (tenant_id, params) => {
    try {
      ...
      if (params.business_unit_template_id) {
        filter.push({
          name: tbl_alias+".business_unit_template_id",
      ...
      let columns = [
        tbl_alias + ".id",
        tbl_alias + ".name",
        "but.id as business_unit_template_id",
        "but.name as business_unit_template_name",
      ];
      let join = [
        {
          ...
          constraint: [
            {
              source: "but.id",
              dest: tbl_alias + ".business_unit_template_id",
              op: "eq",
            },
            {
              type: "and",
